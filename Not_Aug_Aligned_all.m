...
LoadPath_MRI = 'Not_Aug_MRI_Unaligned/';
LoadPath_SURF = 'Not_Aug_SURF_Unaligned/';
StorePath_GT = 'Not_Aug_GT_Aligned/';
StorePath_MRI = 'Not_Aug_MRI_Aligned/';
StorePath_SURF = 'Not_Aug_SURF_Aligned/';
