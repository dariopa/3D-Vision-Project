...
SESSION = '../acdc_logdir/Unaligned_CL9_DL1_200Epoch_0.0001LR5Batch1keep0WD/'
print(SESSION.split("/")[-2])
log_dir_name = 'UnMod_AlDat_CL9_DL1_200Epoch_0.0001LR5Batch1keep0WD'
