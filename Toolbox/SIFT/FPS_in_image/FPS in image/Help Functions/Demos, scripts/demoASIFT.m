...
img1 = imread('image1_MRIMAT.png');
img2 = imread('image7_MRIMAT.png');

info1 = imfinfo('image1_MRIMAT.png');
info2 = imfinfo('image7_MRIMAT.png');


if info1.ColorType ~= 'grayscale'
    img1gr = rgb2gray( img1 );
else
    img1gr = img1;
end
if info2.ColorType ~= 'grayscale'
