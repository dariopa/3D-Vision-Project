...
class DataMakerSynth:
    ...
    def run(self):
        ...
        for idx in range(0, len(subject_ids)):
            ...
            lab = utils.load_vrtx_column(lab_file)
...
if __name__ == '__main__':
    ...
    base_path = '/home/tothovak/work/CSR/Data/augmented_UKBB_data_2D_size_60_60_res_1.8_1.8_sl_4_4_corrected/'
    out_file_name = '/home/tothovak/work/CSR/Data/augmented_UKBB_data_2D_size_60_60_res_1.8_1.8_sl_4_4_corrected/column_augmented_UKBB_data_2D_size_60_60_res_1.8_1.8_sl_4_4_corrected.hdf5'
