...
experiment_name = 'shallow_FCN_full_UKBB_bn'

# Model settings
model_handle = model_zoo.shallow_FCN_bn

# Data settings
data_mode = '2D'  # 2D or 3D
image_size = (200,200)#(60,60)#(212,212)#
target_resolution =  (1.8269,1.8269)#(1.8,1.8)#(1.36719, 1.36719)#
nlabels = 100
num_vertices = 50
start_slice = 4
end_slice = 4
