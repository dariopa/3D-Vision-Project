function [clmnX1, clmnX2, rowY1, rowY2] = SIFT_FP(img1, img2, offx, offy)
% assumption, that we have img1gr and img2gr.
close all;
...
% return values
rowY1 = Match1( :, 1 ); rowY1 = rowY1';
clmnX1 = Match1( :, 2 ); clmnX1 = clmnX1';
rowY2 = Match2( :, 1 ); rowY2 = rowY2';
clmnX2 = Match2( :, 2 ); clmnX2 = clmnX2';
rowY2 = rowY2+offy;
clmnX2 = clmnX2+offx;
end