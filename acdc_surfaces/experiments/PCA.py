...
# Model settings
model_handle = model_zoo.PCA_bn


# Data settings
data_mode = '2D'  # 2D or 3D
image_size = (212, 212)#(200,200)#(60,60)#
target_resolution = (1.36719, 1.36719)#(1.8,1.8)#(1.8269,1.8269)#
nlabels = 100 # number of primary components
num_vertices = 50
start_slice = 2
end_slice = 5
...
max_epochs = 5499 #synthetic PCA with identity PCA and mean # 3000 - synthetic PCA with PCA U and mean
